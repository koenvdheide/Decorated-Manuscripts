...
Folio screenshots are excluded from this repository. They are captured automatically during `visual-confirmation` agent runs and can be regenerated by re-running the agent against the YEK portal.
