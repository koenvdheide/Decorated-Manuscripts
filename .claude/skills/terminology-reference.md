# Islamic Manuscript Terminology Reference

Single source of truth for all technical terminology used in this project. Agents should consult this file rather than maintaining their own term lists.

## Transliteration Conventions

- **Arabic / Persian**: IJMES transliteration system
- **Ottoman Turkish**: Modern Turkish orthography with diacritical marks where needed
- **Original script**: Include in parentheses for key terms on first use
...
| Margin decoration | hâşiye | ḥāshiya (حاشية) | ḥāshiya | marginal decoration |
| Marginal writing | derkenar | hāmiš (هامش) | dar-kanār | marginalia / glosses |
...
| Colored | mülevven | mulauwwan (ملوّن) | mulavvan | colored / tinted |
...
| tamamı yaldız bezemeli | Ott. | Entirely gold-decorated |
...
- **iç kapak** — doublure (inside cover)
- **mukavva** — board
...
- **mecmû'a** — composite manuscript / anthology
- **kıt'a** / **katı'** — calligraphic specimen sheet
- **murakkaa** / **murakkaʿ** — calligraphy/painting album
- **vakfiye** — endowment deed
- **dîvân** — poetry collection
- **mesnevî** — narrative poem (in couplets)
- **mushaf** — Quran manuscript
- **levha** — calligraphic panel / broadsheet

These format terms are useful as search co-anchors: luxury formats (murakkaa, kıt'a, dîvân, mushaf) disproportionately feature decorated paper.

## Spelling Variants for Search
